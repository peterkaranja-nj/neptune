<x-app-layout>
    <head>
        <title>@yield('meta_title', 'Expert Legal Opinions and Corporate Advisory Services')</title>
        <meta name="description" content="@yield('meta_description', 'Expert legal opinions for complex corporate matters, providing clarity, strategic guidance, and full compliance with international legal standards.')">
