<x-app-layout>
     <head>
         <title>@yield('meta_title', 'Investment Fund Setup and Advisory Services for Companies')</title>
         <meta name="description" content="@yield('meta_description', 'Professional setup and management of investment funds, ensuring transparency, regulatory compliance, and optimized performance for investors globally.')">
