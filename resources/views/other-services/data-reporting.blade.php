<x-app-layout>
          <head>
             <title>@yield('meta_title', 'Corporate Data Reporting Services for Compliance and Growth')</title>
             <meta name="description" content="@yield('meta_description', 'Comprehensive data reporting solutions providing accuracy, transparency, and full regulatory compliance to support informed corporate decision-making worldwide.')">
