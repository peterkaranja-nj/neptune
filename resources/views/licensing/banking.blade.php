<x-app-layout>
        <head>
            <title>@yield('meta_title', 'Banking License Services and Support for Global Companies')</title>
            <meta name="description" content="@yield('meta_description', 'Guidance on obtaining banking licenses globally, ensuring your financial operations meet all regulatory requirements and operate smoothly and legally.')">
